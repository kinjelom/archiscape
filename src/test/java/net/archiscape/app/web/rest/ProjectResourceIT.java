...
import net.archiscape.app.repository.ProjectRepository;
...
class ProjectResourceIT {
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).configuration(UPDATED_CONFIGURATION).active(UPDATED_ACTIVE);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).active(UPDATED_ACTIVE);
