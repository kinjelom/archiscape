...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTCONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTCONTENT actions', async () => {
      const expectedActions = [
        {
