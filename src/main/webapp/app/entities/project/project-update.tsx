  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="archiscapeApp.project.home.createOrEditLabel" data-cy="ProjectCreateUpdateHeading">
            <Translate contentKey="archiscapeApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('archiscapeApp.project.name')}
                id="project-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('archiscapeApp.project.description')}
              ...
              />
              <ValidatedField
                label={translate('archiscapeApp.project.configuration')}
              ...
              />
              <ValidatedField
                label={translate('archiscapeApp.project.active')}
                id="project-active"
                name="active"
                data-cy="active"
                check
              ...
              <ValidatedField
                ...
                name="landscape"
                data-cy="landscape"
                label={translate('archiscapeApp.project.landscape')}
                type="select"
                required
              >
                <option value="" key="0" />
